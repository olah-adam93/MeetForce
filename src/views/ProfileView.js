          ...
          <div className='user-head-data'>
            <section>
              <p>
                ...
                {userData.userLog.user.email}
              </p>
              {/* <p>{userData.userLog.userDetails?.birthday}</p> */}
              <p>
                <FontAwesomeIcon icon={faLocationDot} className='plane-icon' />
                {userData.userLog.userDetails?.location}
              </p>
            </section>
            <section>
        ...
        <div className='user-head'>
          <div className='profile-statistics'>
            <div>
              <h2>Statistics</h2>
              <h3>
                Events number totally: <span>{eventsLength}</span>
              </h3>

              <h3>
                Events number you created: <span>{filtered.length}</span>
              </h3>

              <h3>
                Events number you joined: <span>{eventsCard.length}</span>
              </h3>
            </div>
